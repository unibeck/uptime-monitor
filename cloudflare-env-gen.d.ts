/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnvGen cloudflare-env-gen.d.ts` (hash: 8e72fde9098b0ae31088f947a445befd)
// Runtime types generated with workerd@1.20250416.0 2024-09-26 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		OKTA_DISCOVERY_URL: string;
		MONITOR_TRIGGER: DurableObjectNamespace /* MonitorTrigger from api */;
		DB: D1Database;
		MONITOR_EXEC: Fetcher;
		MONITOR_TRIGGER_RPC: Fetcher;
		ASSETS: Fetcher;
	}
}
interface CloudflareEnvGen extends Cloudflare.Env {}
